...
def _add_common_args(arg_parser):
    ...
    arg_parser.add_argument("--ignore_gpu_usage", action="store_true",
                            help="If ignored, will occupy gpu which is been used")
    ...
    arg_parser.add_argument('--use_msf', action="store_true",
                            help="Use multi-scale feature in decoder or use token-level sentence encoding")
    arg_parser.add_argument('--use_topk_query', action="store_true",
                            help="Use top-k query or use query embedding, take effect if fpn_type is not None")
    arg_parser.add_argument('--fpn_layer', type=int, default=16, help="")
    arg_parser.add_argument("--fpn_type", type=str, default=None,
                            choices=[None, "uni-lstm", "bi-lstm", "uni", "bi", "uni-attn", "bi-attn"])

    arg_parser.add_argument('--num_dec_layer', type=int, default=3, help="")
    ...
    arg_parser.add_argument('--wordvec_path', type=str)
